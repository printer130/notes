...
*Local:* Shellcode is used to exploit local processes in order to get higher privileges on thatr machine.

*Remote:* Is sent through the network along with an exploit. The exploit will allow the shellcode to be injected into the process and executed.
