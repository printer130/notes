...
*Nota:* Para poder husmear paquetes usando arpspoof, necesitarás usar la misma puerta de enlace por defecto que usan tus objetivos puedes ver los comandos de arriba.
...
Para tener una visión general del tipo de tráfico que hemos capturado, tenemos que abrir el archivo de captura Task5.pcap y luego desde el menú: *Statistics > Protocol Hierarchy* para tener una idea de que clase de tráfico estamos viendo.
...
Manteniendo la captura task6.pcap abierta en Wireshark, vamos a seleccionar en el menú Archivo: *Export Objects > HTTP*

#### Filtro SMB

Probando el acceso a la parte UNC: \\172.16.5.10\finance, podemos usar el comando *mount*.
